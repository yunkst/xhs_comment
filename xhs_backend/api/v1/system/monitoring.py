...
系统管理域 - 系统状态查询、健康检查、版本信息和数据库统计功能
"""
...
@router.get("/database-stats", response_model=Dict[str, Any], summary="数据库统计")
...
@router.get("/version", response_model=Dict[str, Any], summary="版本信息")
