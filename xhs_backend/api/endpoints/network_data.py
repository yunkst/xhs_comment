...
# 创建路由器
router = APIRouter(prefix="/network-data", tags=["网络数据处理"])
...
async def receive_network_data(
    ...
    try:
        ...
        if data.response_body:
            try:
                from ..services.network_data_processor import network_processor
                from ..models.network import RawNetworkData
...
async def get_network_data_stats(
    ...
    try:
        ...
        try:
            from ..models.network import NetworkDataStats
